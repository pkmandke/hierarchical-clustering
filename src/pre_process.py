...
class Doc2vec_wrapper:
    ...
    def __init__(self, json_path, n_docs=-1):
        ...
        self.dframe = pd.read_json(json_path, orient=str, line=True)[['identifier-uri', 'description-abstract']]
        if n_docs == -1:
    ...
    def load_model_and_build_vocab(vector_size=20, min_count=2, epochs=20, workers=1):
    ...
    def save_model(self, path='../obj/doc2vec_'):
